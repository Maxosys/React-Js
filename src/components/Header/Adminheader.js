...
export default class Adminheader extends React.Component {
  ...
  render() {
      ...
      return (
          ...
          <nav className="navbar navbar-inverse navbar-fixed-top dashboard" role="navigation">
    ...
    <div className="collapse navbar-collapse navbar-ex1-collapse">
      <ul className="nav navbar-nav side-navsss">
        ...
        <li>
          <a href="#" data-toggle="collapse" data-target="#submenu-2">Community Managment <i className="fa fa-fw fa-angle-down pull-right"></i></a>
