 ...
 let loginornot = ""
  ...
  let loginornot = (<button class="btn button--primary" type="submit">Join Now <i aria-hidden="true" class="fa fa-angle-right"></i> </button> );
    ...
    return (
            ...
            <div class="login-section bg-ribbins">
      <div class="container">
        <div class="tab-wrap">
          <h2 class="head-title">Join Community</h2>
          <div class="card">
            <div class="joincard-img"><img src="/images/big-community-card.png" /></div>
            <div class="memberinfo">
              <span class="members-name">{this.state.community_name}</span>
              <div class="totalmember">Owner Name : <span class="m-number">{this.state.owner_name}</span></div>
            </div>
